    ...
    <>
      <header className="sticky top-0 z-50 backdrop-blur-md bg-[#051A12]/90 border-b border-[#A6FF2E]/15 transition-all">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-7 text-xs sm:text-sm font-medium tracking-wide text-[#DADDD6]">
            <button
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            >
              ...
              <span className={lang === "en" ? "text-[#A6FF2E] font-bold" : "text-white/80"}>
                EN
              </span>
              <span className="opacity-40 text-white">/</span>
              <span
                className={lang === "ar" ? "text-[#A6FF2E] font-bold" : "text-white/80"}
      ...
      <RequestWebsiteDialog open={requestModalOpen} onOpenChange={setRequestModalOpen} />
    </>
  );
}
